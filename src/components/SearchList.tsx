...
const SearchList = (props:{query:dbNotes}) => {
    ...
    return (
        <div className={"w-full absolute z-20 m-0 text-black gap-2 grid grid-cols-12 justify-center top-24 md:top-[47px] lg:top-[48px]"}>
            <div className={"lg:ml-[16px] mr-[14px] m-0 col-span-12 md:col-start-5 md:col-end-11 md:ml-3 md:mr-1 rounded-sm border border-[#FF7F50] lg:col-start-4 lg:col-end-12 flex flex-wrap bg-white lg:mr-[10px]"}>
            {query?.map(note => {
                return (
