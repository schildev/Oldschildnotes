...
const Navbar = () => {
    return (
        <header className={"bg-indigo-500 border-b shadow-md shadow-violet-300/50 py-3 align-center justify-start gap-3 border-violet-600"}>
                ...
                <h2 className={"flex basis-8/12 md:basis-4/12 lg:basis-3/12 justify-start md:justify-center items-center text-3xl text-start " + HeadingRowdiesFont.className}>Schildnotes</h2>
                    <SearchForm />
                    <NavbarLinks />
                </div>
        </header>
